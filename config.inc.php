...
version_compare(PHP_VERSION, '5.6.0') <= 0 ? error_reporting(E_WARNING & ~E_NOTICE & ~E_DEPRECATED & E_ERROR) : error_reporting(E_WARNING & ~E_NOTICE & ~E_DEPRECATED  & E_ERROR & ~E_STRICT); // PRODUCTION
...
$HELPDESK_SUPPORT_EMAIL_ID = 'CEO@ar.e-egar.com';
$HELPDESK_SUPPORT_NAME = 'EGAR';
...
$dbconfig['db_password'] = 'ZeroCall20!@H';
...
$site_URL = 'https://demo.jethosted.com/';
//$site_URL = 'https://ar.e-egar.com/404.html';

// url for customer portal (Example: http://vtiger.com/portal)
//$PORTAL_URL = $site_URL.'/customerportal';
// root directory path
$root_directory = '/var/www/html/demo/';
...
$limitpage_navigation = '7';

// history_max_viewed default value = 5
$history_max_viewed = '5';

// default_module default value = Home
$default_module = 'Products';
...
$application_unique_key = '983078becf9cfdb6a28f971c4ec9df34';
