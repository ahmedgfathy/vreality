			...
			<div class="menuBar row-fluid">
				...
				<div class="span9">
					<ul class="nav modulesList" id="largeNav">
						...
						<li>
							<a class="alignMiddle" style="background-color:white;" href="https://web.whatsapp.com/" target="_blank"><img src="https://i2.wp.com/tochat.be/whatsapp-icon-white.png?ssl=1" width="20px" height="20px" alt="" title="Whats App" /></a>	
						</li>
						<li>
							<a class="alignMiddle" style="background-color:white;" href="https://www.facebook.com/Egar.newcairo/inbox" target="_blank"><img src="https://cdnlogo.com/logos/f/51/facebook-messenger-white.svg" width="20px" height="20px" alt="" title="EGAR MSG" /></a>								
						</li>
						<li>
                               <!--<a class="alignMiddle" style="background-color:white;" href="https://www.xcite-eg.com/?page_id=375" target="_blank"><img src="https://www.iconhot.com/icon/png/brush-intense-messenger/256/buddy-bleu.png" width="20px" height="20px" alt="" title="Add Leads" /></a>--!>
						</li>
