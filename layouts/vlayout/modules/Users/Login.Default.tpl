...
<html>
	<head>
		<title>EGAR.COM login page</title>
								...
								<div class="span6">
									<div class="login-area">
										<div class="login-box" id="loginDiv">
											<div class="">
												<h3 class="login-header">Login to EGAR.COM</h3>
		</div>
			...
			<div class="control-group">
				...
				<div class="controls">
											...
											<div class="login-subscript">
												<small> Powered by EGAR.COM</small>
											</div>
				</div>
					...
					<div class="row-fluid">
						<div class="span6 pull-left" >
							<div class="footer-content">
									...
									<a href="https://www.e-egar.com">EGAR.COM</a><small>&nbsp Design and Developed By Ahmed Fathy&nbsp&copy {date('Y')}&nbsp;<!-- | 
